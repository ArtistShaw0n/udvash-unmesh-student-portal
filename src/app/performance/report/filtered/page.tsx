...
export default function PerformanceReportFilteredPage() {
  return (
    <main className="relative mx-auto min-h-[2734px] w-[376px] overflow-hidden bg-white dark:bg-[#111111]">
      ...
      <ExamResultCard top={424} status="In Branch" statusColor="#25b7d3" actions={[{ label: "View Result", left: 41, width: 106 }, { label: "View Question", left: 167, width: 120 }]} />
      ...
      <div className="absolute left-[24px] top-[2565px] flex h-[73px] w-[328px] items-start justify-between rounded-[10px] bg-white px-[20px] pt-[20px] shadow-[0px_0px_5px_0px_rgba(0,0,0,0.1)] dark:border dark:border-[#1c1c1c] dark:bg-[#1a1a1a] dark:shadow-[0px_0px_20px_0px_#000000]">
        <span className="flex items-center gap-[8px]">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={`${I}/badge.svg`} alt="" aria-hidden="true" className="size-[20px]" />
