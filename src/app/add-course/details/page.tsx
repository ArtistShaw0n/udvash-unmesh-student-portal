...
function Dropdown({ top, value, blue, chevron }: { top: number; value: string; blue?: boolean; chevron?: boolean }) {
  return (
    <div className="absolute left-[28px] flex h-[40px] w-[320px] items-center justify-between rounded-[5px] border border-[#b9b9b9] bg-white px-[10px] dark:border-[#444444] dark:bg-[#1a1a1a]" style={{ top }}>
...
function CheckRow({ left, top, checked, label }: { left: number; top: number; checked?: boolean; label: string }) {
  return (
    <div className="absolute flex items-center gap-[8px]" style={{ left, top }}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
...
function BatchPill({ top, label }: { top: number; label: string }) {
  return (
    <div className="absolute left-[28px] flex h-[32px] w-[320px] items-center justify-between rounded-[99px] bg-white px-[14px] shadow-[0px_0px_5px_0px_rgba(0,0,0,0.1)] dark:bg-[#2c2c2c]" style={{ top }}>
...
export default function AddCourseDetailsPage() {
  return (
    <main className="relative mx-auto h-[1104px] w-[376px] overflow-hidden bg-white dark:bg-[#111111]">
      ...
      {/* form card */}
      <div className="absolute left-1/2 top-[146px] h-[862px] w-[360px] -translate-x-1/2 rounded-[10px] bg-white shadow-[0px_0px_5px_0px_rgba(0,0,0,0.1)] dark:border dark:border-[#1c1c1c] dark:bg-[#1a1a1a] dark:shadow-[0px_0px_20px_0px_#000000]" />
      ...
      {/* course card */}
      <div className="absolute left-[16px] top-[564px] flex h-[76px] w-[344px] items-center gap-[8px] rounded-[5px] bg-white pl-[17px] pr-[12px] shadow-[0px_0px_5px_0px_rgba(0,0,0,0.1)] dark:bg-[#2c2c2c]">
        {/* eslint-disable-next-line @next/next/no-img-element */}
