...
function QaRow({ top, color, icon, title }: { top: number; color: string; icon: string; title: string }) {
  return (
    <div className="absolute left-1/2 h-[68px] w-[336px] -translate-x-1/2 rounded-[10px] bg-white shadow-[0px_0px_5px_0px_rgba(0,0,0,0.1)] dark:border dark:border-[#1c1c1c] dark:bg-[#1a1a1a] dark:shadow-[0px_0px_20px_0px_#000000]" style={{ top }}>
