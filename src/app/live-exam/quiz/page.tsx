 ...
 *   header + chapter title (y70) + quiz subtitle (y128) + info card (y157:
 *   Question/Marks/Duration row + Version/(-)Marks row, (-)Marks red #f95959) +
 *   "Remaining: 09:10" timer bar (y229, #55347b → dark #9061c8) + 5 question cards
 *   (pill #f6f6f6→#2c2c2c + stem [+ (i)(ii)(iii) sub-points] + 4 lettered options,
 *   #616161 ring + #cacaca row dividers) + Submit (y1919, #55347b→#9061c8) + footer.
 *   Frame 376×2051, absolute Figma coords; each card fixed at its Figma y/height.
 */
